...
impl OAuth2Handler {
    ...
    pub fn authorize_url(&self) -> (String, String, String) {
        #[cfg(feature = "tracing")]
        debug!("Generating OAuth2 authorization URL with PKCE");
        ...
        #[cfg(feature = "tracing")]
        info!("Authorization URL generated successfully");
    ...
    /// * `pkce_verifier` - The PKCE verifier generated during `authorize_url()`
    ///
    /// # Security
    ///
    ...
    pub async fn exchange_code(&self, code: String, pkce_verifier: String) -> Result<AccessToken> {
        ...
        let token_result = self
            ...
            .map_err(|e| {
                ...
                Error::OAuth2Error(format!("Token exchange failed: {}", e))
            })?;
        ...
        #[cfg(feature = "tracing")]
        info!(expires_in_secs = expires_in, "Token exchange successful");
    ...
    pub async fn refresh_token(&self, refresh_token: String) -> Result<AccessToken> {
        ...
        let token_result = self
            ...
            .map_err(|e| {
                ...
                Error::OAuth2Error(format!("Token refresh failed: {}", e))
            })?;
        ...
        #[cfg(feature = "tracing")]
        info!(expires_in_secs = expires_in, "Token refresh successful");
